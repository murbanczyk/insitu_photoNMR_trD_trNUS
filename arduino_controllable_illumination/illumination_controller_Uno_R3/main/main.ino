/*
 FWest Arduino UNO R3 / MEGA2560 v20.07.2023
 ...
 - Communication is sometimes randomly not working anymore, the Rx/Tx LEDs turn on
   ...
   Apparently this can be accounted to voltage fluctuations, etc. and may not be necessary on all systems
...
void setup() 
{
  ...
  // The if statement prints a string permanently stored in EEPROM (Starting from 0x0000), if present
